...
export const RechargeActivitiesList = ({ onActivitySelect }: ActivityListsProps) => {
  ...
  // Show all activities, no limitations
  const allDefaultActivities = defaultRechargeActivities;
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {allDefaultActivities.map(activity => (
...
export const DepletingActivitiesList = ({ onActivitySelect }: ActivityListsProps) => {
  ...
  // Show all activities, no limitations
  const allDefaultActivities = defaultDepletingActivities;
